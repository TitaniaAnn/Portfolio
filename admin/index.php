    ...
    <div class="panel" id="panel-add-project">
      ...
      <div class="form-grid">
        ...
        <div class="form-group full">
          ...
          <textarea id="ap-desc" rows="3" placeholder="What does this project do?"></textarea>
        </div>
  ...
  <div class="modal">
    ...
    <div class="modal-body">
      ...
      <div class="form-grid">
        ...
        <div class="form-group full"><label>Description <span class="req">*</span></label><textarea id="edit-desc" rows="3"></textarea></div>
...
async function addProject() {
  ...
  const body = {
    title, description: desc, language: lang,
    tags,
...
function resetAddForm() {
  ['ap-title','ap-desc','ap-tags','ap-github','ap-demo'].forEach(id => document.getElementById(id).value = '');
